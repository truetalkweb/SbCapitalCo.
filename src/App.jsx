...
export default function App() {
  ...
  const {
    ...
    fmpAiMovers,
    fmpSmallCaps,
    verifiedScannerMovers,
    contextScannerMovers,
    scannerLoading,
    scannerMeta,
    ...
    return (
      <PremiumWorkspace
        ...
        scannerGroups={{
          ...
          unusualVolume: fmpUnusualVolume,
          newsMovers: fmpNewsMovers,
          newHighs: fmpNewHighs,
          newLows: fmpNewLows,
          premarket: fmpPremarket,
          aiMovers: fmpAiMovers,
          smallCaps: fmpSmallCaps,
          verifiedMovers: verifiedScannerMovers,
          contextMovers: contextScannerMovers,
        }}
        scannerMeta={scannerMeta}
        news={news}
        newsLoading={newsLoading}
